...
@section('content')
 ...
 <div class="container-fluid">
     ...
     <section id="head-section">
         <div class="row">
             <div class="col-sm-12 col-md-9 col-xl-5 col-lg-5">
                 <div class="col-12">Information Rapport:&nbsp;<span class="valeur">   <span class="valeur"> Epais: {{$rapport->details->Epaisseur}} mm -Diam : {{$rapport->details->Diametre}}mm</span></span></div>
             ...
             <div class="col-sm-12 col-md-8 col-xl-3 col-lg-3">
                 <div class="row">Agent1: &nbsp; <span class="valeur"> {{explode('/',$rapport->NomAgents)[0]}} / {{explode('/',$rapport->CodeAgent)[0]}}</span></div>
                 <div class="row">Agent2: &nbsp; <span class="valeur">{{explode('/',$rapport->NomAgents)[1]}} / {{explode('/',$rapport->CodeAgent)[1]}}</span></div>
             </div>
     ...
     <div class="row">
             ...
             <section class="top-actions">
                 ...
                 <div class="row ">
                    ...
                    <input class=" col-1" type="checkbox" id="Sond" name="Sond" >
                     ...
                     <button type="reset" class="col-2  btn btn-secondary" type="button" id="annulerButton" >Annuler</button>
                     <button type="button" class="col-4   offset-1  btn btn-success" type="button" id="Ajouter" >Ajouter</button>
                 </div>
                 </form>
             </section>
         </div>
             ...
             <section class="top-actions">
                 ...
                 <form id="Form1">
                             ...
                             <td class=" " style="width:35%">  <select class="form-control" id="defaut1" name="defaut1"    >
                                     ...
                                     @if(isset($defautsSoudure))
                                         @foreach($defautsSoudure as $defaut )
                                             <option defautId="{{$defaut->id}}"       data-tokens="{{$defaut->Defaut}}" value="{{$defaut->Defaut}}"  class="my-select">{{$defaut->Defaut}}</option>
                                         @endforeach
                                     @endif
                                 </select></td>
                    ...
                    <div class="row actions">
                        <div class="col-1"><button id="addObsSoudure" class="btn btn-success"><b>+</b></button> </div>
                        <div class="col-1"><button id="removeObsSoudure" class="btn btn-danger"><b>-</b></button> </div>
                    </div>
                 <div class="row">
         ...
         <div class="col-xl-4 col-lg-6  col-md-6 col-sm-12">
             <section class="top-actions">
                 ...
                 <div class="row actions">
                     <div class="col-1"><button id="addObsMetal" class="btn btn-success"><b>+</b></button> </div>
                     <div class="col-1"><button id="removeObsMetal" class="btn btn-danger"><b>-</b></button> </div>
                 </div>
                 <div class="row">
             ...
             @if(isset($visuels))
                 @foreach($visuels as $visuel)
                     <tr id="visuel{{$visuel->Numero}}">
                         ...
                         <td id="bis{{$visuel->Numero}}">@if($visuel->Bis) <input type="checkbox" checked  onclick="return false;">
                             @elseif(!$visuel->Bis)<input type="checkbox"  onclick="return false;"> @endif</td>
                         <td id="sond{{$visuel->Numero}}">@if($visuel->Sond) <input type="checkbox" checked  onclick="return false;">
                         ...
                         <td>
                             <button id="visuel{{$visuel->Numero}}Edit" class="visuelEdit text-primary" ><i class="fa fa-edit"></i></button>
                             <button id="visuel{{$visuel->Numero}}Delete" class="visuelDelete text-danger" ><i class="fa fa-trash"></i></button></td></td>
                         </td>
                     </tr>
                 @endforeach
             @endif
     ...
     <section>
         <div class="row">
             <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">  <button  type="button" class="btn btn-outline-danger col-12"  data-toggle="modal" data-target="#staticBackdrop">
                     <b>Arrets Machine</b>
                 </button></div>
             <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">  <button   type="button" id="imprimer" class="btn btn-outline-primary col-12"   >
                    <b>Imprimer</b>
                 </button></div>
             <div class="col-xl-2 offset-xl-4 col-lg-3  col-md-6 col-sm-12">
                 <form method="post" action="{{route('rapports_visuels.destroy',["id"=>$rapport->Numero])}}">
                     @csrf
                     <input type="hidden" name="_method" value="delete">
                     <button class="btn btn-outline-warning col-12"><b>Quitter le rapport</b></button>
                 </form>
             </div>
             <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12"><button id="cloturer" class="btn btn-success col-12"><b>Clôturer Rapport</b></button></div>
         </div>
     </section>
 </div>
 <!-- Modal -->
