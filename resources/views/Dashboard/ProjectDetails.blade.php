...
<div class="container-fluid">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
             ...
             <a class="nav-item nav-link @if(isset($target)&& $target=='clients') active @endif" id="nav-clients-tab" data-toggle="tab" href="#nav-clients" role="tab" aria-controls="nav-clients" aria-selected="true"><b>Clients</b></a>
            <a class="nav-item nav-link "   href="{{route('projects.index')}}"  ><b>Projets</b></a>
            {{--<a class="nav-item nav-link  @if(isset($target)&& $target=='clients') active @endif" id="nav-clients-tab" data-toggle="tab" href="#nav-clients" role="tab" aria-controls="nav-clients" aria-selected="false"><b>clients</b></a>--}}

        </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade @if(isset($target)&& $target=='clients') show active @endif " id="nav-clients" role="tabpanel" aria-labelledby="nav-clients-tab">
            <div class="row">
                <div class="col-12">
                    <section >
                        <h4 class="text-center bg-gradient-primary text-white"><b>Gestion Des Clients</b></h4>
                        <hr>
                        <form id="clientsForm" class="row text-center">
                            ...
                            <div class="col-xl-2 col-lg-3 col-sm-3 form-group  actions ">
                                ...
                                <button type="button" id="AnnulerClient" class=" btn btn-danger" style="width:35px; height:35px; padding:0;" ><i class="fa fa-times"></i></button>
                                <button type="button" id="AjouterClient" style="width:35px; height:35px; padding:0;" class=" btn btn-success"><i class="fa fa-plus"></i></button>
                            </div>
                        </form>
                        <hr>
                        <div id="cont">
