                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="DashboardTableContainer">
                                <table class="table table-borderless table-striped" id="DashboardTable"
                                       cellspacing="0">
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#DashboardTable_wrapper .row').height() + 5;
                    var width = (($('#DashboardTableContainer').width() - $('#tr-actions').width()) / 2);
