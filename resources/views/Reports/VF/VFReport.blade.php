...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#VFReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
        ...
        function getData() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#VFReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).clear().draw();
                    ...
                    if (result.reports.length > 0) {
                        ...
                        $('#VFReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).draw(false);
