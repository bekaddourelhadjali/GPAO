        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RevExtReport" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RevExtReport-tab" data-toggle="tab"
                               href="#nav-RevExtReport" role="tab" aria-controls="nav-RevExtReport"
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="RevExtReportTableContainer">
                                <table class="table table-bordered table-striped" id="RevExtReportTable"
                                       cellspacing="0">
        ...
        function addActions() {
            ...
            $("#Reports TR ").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#RevExtReportTable_wrapper .row').height() + 5;
...
@endif
        function getData() {
            ...
            $.ajax({
                url: "{{url('/RevExtDailyRep')}}/" + $('#date').val(),
                method: 'get',
                data: {
                    poste: $('#poste').val(),
                    Did: $('#Did').val(),
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            ...
                            $('#RevExtReportTable tbody tr:last-child')
