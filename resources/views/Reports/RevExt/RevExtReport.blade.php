...
@section('style')
    <title>Rapports De Revêtement Extérieur Des Tubes</title>
    <style>
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RevExtReport" role="tabpanel"
                 aria-labelledby="nav-RevExtReport-tab ">
                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RevExtReport-tab" data-toggle="tab"
                               href="#nav-RevExtReport" role="tab" aria-controls="nav-RevExtReport" aria-selected="true"><b>Filtrage par détails de projet</b></a>
                            <a class="nav-item nav-link  "  href="{{route('RevExtRepAdv.index')}}"><b>Filtres Avancés</b></a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container">
                                <table class="table table-borderless table-striped" id="RevExtReportTable"  cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#RevExtReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
           calculateColumn(5); calculateColumn(6); calculateColumn(7);
        $('#RevExtReportTable_filter input[type=search]').keyup(function () {
           calculateColumn(5); calculateColumn(6); calculateColumn(7);
        });
        });
        ...
        function getData() {
            ...
            $.ajax({
                url: "{{url('/RevExtReport')}}/" + $('#Did').val(),
                method: 'get',
                data: {
                },
                success: function (result) {
                    $('#RevExtReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).clear().draw();
                    ...
                    if (result.reports.length > 0) {
                        ...
                        $('#RevExtReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).draw(false);
                        $('#RevExtReportTable tbody tr').attr('style','display: table-row;');
                    }
