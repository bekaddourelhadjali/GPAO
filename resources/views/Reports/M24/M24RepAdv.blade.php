...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-M24RepAdv" role="tabpanel"
                 aria-labelledby="nav-M24RepAdv-tab">
                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-M24RepAdv-tab" data-toggle="tab"
                               href="#nav-M24RepAdv" role="tab" aria-controls="nav-M24RepAdv" aria-selected="true">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="table-container">
                        <table class="col-12 table table-bordered  table-striped" id="M24ReportTable" style="min-width: 800px">
                            <tbody id="Reports">
                            <tr id="Filter_TR">
                                @if(isset($M24Report))
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            chartId='myBarChart';
            labels=@json(array_column($M24Report,'Filter'));
            data=@json(array_column($M24Report,'NBT'));
