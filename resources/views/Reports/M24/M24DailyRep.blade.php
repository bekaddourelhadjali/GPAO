        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-M24Report" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-M24Report-tab" data-toggle="tab"
                               href="#nav-M24Report" role="tab" aria-controls="nav-M24Report"
                               aria-selected="true"><b>Rapport Journalier</b></a>
                            <a class="nav-item nav-link  " href="{{route('M24Report.index')}}">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="M24ReportTableContainer">
                                <table class="table table-bordered table-striped" id="M24ReportTable"
                                       cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        var table = $('#M24ReportTable').DataTable({
        ...
        $(document).ready(function () {
            ...
            $('.reportEdit').click(function () {
                ...
                var win = window.open("{{url('/M24/')}}/" + id, '_blank');
                if (win) {
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#M24ReportTable_wrapper .row').height() + 5;
                    var width = (($('#M24ReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            ...
                            $('#M24ReportTable tbody tr:last-child')
