        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-USReport" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-USReport-tab" data-toggle="tab"
                               href="#nav-USReport" role="tab" aria-controls="nav-USReport"
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="USReportTableContainer">
                                <table class="table table-borderless table-striped" id="USReportTable"
                                       cellspacing="0">
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#USReportTable_wrapper .row').height() + 5;
                    var width = (($('#USReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0){
                        result.reports.forEach(function (item) {
                            ...
                            $('#USReportTable tbody tr:last-child')
