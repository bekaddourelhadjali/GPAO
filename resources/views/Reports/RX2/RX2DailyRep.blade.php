        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RX2Report" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RX2Report-tab" data-toggle="tab"
                               href="#nav-RX2Report" role="tab" aria-controls="nav-RX2Report"
                               aria-selected="true"><b>Rapport Journalier</b></a>
                            <a class="nav-item nav-link  " href="{{route('RX2Report.index')}}">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="RX2ReportTableContainer">
                                <table class="table table-bordered table-striped" id="RX2ReportTable"
                                       cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        var table = $('#RX2ReportTable').DataTable({
            "bDestroy": true,
            "bRetrieve": true
        });
        ...
        $(document).ready(function () {
            ...
            $('.reportEdit').click(function () {
                ...
                var win = window.open("{{url('/RX2/')}}/" + id, '_blank');
                if (win) {
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#RX2ReportTable_wrapper .row').height() + 5;
                    var width = (($('#RX2ReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            ...
                            $('#RX2ReportTable tbody tr:last-child')
