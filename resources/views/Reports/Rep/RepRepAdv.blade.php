...
@section('style')
    <title>Rapports De Soudure Manuelle</title>
    <style>
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RepRepAdv" role="tabpanel"
                 aria-labelledby="nav-RepRepAdv-tab">
                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RepRepAdv-tab" data-toggle="tab"
                               href="#nav-RepRepAdv" role="tab" aria-controls="nav-RepRepAdv" aria-selected="true">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="table-container">
                        <table class="col-12 table table-bordered  table-striped" id="RepReportTable" style="min-width: 800px">
                            <tbody id="Reports">
                            <tr id="Filter_TR">
                                @if(isset($RepReport))
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            chartId='myBarChart';
            labels=@json(array_column($RepReport,'Filter'));
            data=@json(array_column($RepReport,'NBT'));
