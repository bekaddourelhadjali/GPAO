                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RevIntReport-tab" data-toggle="tab"
                               href="#nav-RevIntReport" role="tab" aria-controls="nav-RevIntReport" aria-selected="true"><b>Filtrage par détails de projet</b></a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container">
                                <table class="table table-borderless table-striped" id="RevIntReportTable"  cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#RevIntReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
           calculateColumn(5); calculateColumn(6); calculateColumn(7);
        $('#RevIntReportTable_filter input[type=search]').keyup(function () {
           calculateColumn(5); calculateColumn(6); calculateColumn(7);
        });
        });
