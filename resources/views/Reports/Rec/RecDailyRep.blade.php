...
@section('style')
    <title>Rapports De Réception Des Tubes</title>
    <style>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RecReport" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RecReport-tab" data-toggle="tab"
                               href="#nav-RecReport" role="tab" aria-controls="nav-RecReport"
                               aria-selected="true"><b>Rapport Journalier</b></a>
                            <a class="nav-item nav-link  " href="{{route('RecReport.index')}}">
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="RecReportTableContainer">
                                <table class="table table-bordered table-striped" id="RecReportTable"
                                       cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        var table = $('#RecReportTable').DataTable({
        ...
        $(document).ready(function () {
            ...
            $('.reportEdit').click(function () {
                ...
                var win = window.open("{{url('/Reception/')}}/" + id, '_blank');
                if (win) {
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#RecReportTable_wrapper .row').height() + 5;
                    var width = (($('#RecReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            $('#RecReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).row.add([
                                'Poste ' + item.Poste,
                                item.Machine,
                                item.Tube,
                                +item.Bis,
                            ...
                            $('#RecReportTable tbody tr:last-child')
