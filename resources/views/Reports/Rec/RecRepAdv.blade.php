...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RecRepAdv" role="tabpanel"
                 aria-labelledby="nav-RecRepAdv-tab">
                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RecRepAdv-tab" data-toggle="tab"
                               href="#nav-RecRepAdv" role="tab" aria-controls="nav-RecRepAdv" aria-selected="true">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="table-container">
                        <table class="col-12 table table-bordered  table-striped" id="RecReportTable" style="min-width: 800px">
                            <tbody id="Reports">
                            <tr id="Filter_TR">
                                @if(isset($RecReport))
                                    @foreach($RecReport as $item)
                                    <th >{{$item->Filter}}</th>
                                @endforeach
                                @endif
                            </tr>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            chartId='myBarChart';
            labels=@json(array_column($RecReport,'Filter'));
            data=@json(array_column($RecReport,'LT'));
