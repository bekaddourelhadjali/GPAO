                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-VisuelReport-tab" data-toggle="tab"
                               href="#nav-VisuelReport" role="tab" aria-controls="nav-VisuelReport" aria-selected="true"><b>Filtrage par détails de projet</b></a>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#VisuelReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
