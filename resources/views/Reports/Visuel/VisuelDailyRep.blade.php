...
@section('style')
    <title>Rapports De Contrôle Visuel</title>
    <style>
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-VisuelReport" role="tabpanel"
                 aria-labelledby="nav-VisuelReport-tab">

                <section>
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">

                            <a class="nav-item nav-link active " id="nav-VisuelReport-tab" data-toggle="tab"
                               href="#nav-VisuelReport" role="tab" aria-controls="nav-VisuelReport"
                            ...
                            <a class="nav-item nav-link  " href="{{route('VisuelRepAdv.index')}}"><b>Filtres Avancés</b></a>
...
@section('script')
    ...
    <script>
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#VisuelReportTable_wrapper .row').height() + 5;
                    var width = (($('#VisuelReportTableContainer').width() - $('#tr-actions').width()) / 2);
        ...
        function getData() {
            ...
            $.ajax({
                url: "{{url('/VisuelDailyRep')}}/" + $('#date').val(),
                method: 'get',
                data: {
                    poste: $('#poste').val(),
                    Did: $('#Did').val(),
