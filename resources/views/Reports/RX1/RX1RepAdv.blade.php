...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-RX1RepAdv" role="tabpanel"
                 aria-labelledby="nav-RX1RepAdv-tab">
                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-RX1RepAdv-tab" data-toggle="tab"
                               href="#nav-RX1RepAdv" role="tab" aria-controls="nav-RX1RepAdv" aria-selected="true">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="table-container">
                        <table class="col-12 table table-bordered  table-striped" id="RX1ReportTable" style="min-width: 800px">
                            <tbody id="Reports">
                            <tr id="Filter_TR">
                                @if(isset($RX1Report))
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            chartId='myBarChart';
            labels=@json(array_column($RX1Report,'Filter'));
            data=@json(array_column($RX1Report,'NBT'));
