                ...
                <section >
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link  "  href="{{route('RX1DailyRep.index')}}">
                                <b>Rapport Journalier</b></a>
                            <a class="nav-item nav-link active " id="nav-RX1Report-tab" data-toggle="tab"
                               href="#nav-RX1Report" role="tab" aria-controls="nav-RX1Report" aria-selected="true"><b>Filtrage par détails de projet</b></a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container">
                                <table class="table table-borderless table-striped" id="RX1ReportTable"  cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#RX1ReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
             calculateColumn(4);
        $('#RX1ReportTable_filter input[type=search]').keyup(function () {
            calculateColumn(4);
        });
        });
        ...
        function getData() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#RX1ReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).clear().draw();
                    ...
                    if (result.reports.length > 0) {
                        ...
                        $('#RX1ReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]}).draw(false);
                        $('#RX1ReportTable tbody tr').attr('style','display: table-row;');
                    }
