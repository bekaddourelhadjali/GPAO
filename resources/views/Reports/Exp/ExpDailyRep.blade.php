        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-ExpReport" role="tabpanel"
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-ExpReport-tab" data-toggle="tab"
                               href="#nav-ExpReport" role="tab" aria-controls="nav-ExpReport"
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="ExpReportTableContainer">
                                <table class="table table-bordered table-striped" id="ExpReportTable" width="120%"
                                       cellspacing="0">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.reportEdit').click(function () {
                ...
                var win = window.open("{{url('/Expedition/')}}/" + id, '_blank');
                if (win) {
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#ExpReportTable_wrapper .row').height() + 5;
                    var width = (($('#ExpReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            ...
                            $('#ExpReportTable tbody tr:last-child')
