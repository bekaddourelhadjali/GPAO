                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active " id="nav-VFRReport-tab" data-toggle="tab"
                               href="#nav-VFRReport" role="tab" aria-controls="nav-VFRReport" aria-selected="true"><b>Filtrage par détails de projet</b></a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container">
                                <table class="table table-borderless table-striped" id="VFRReportTable"  cellspacing="0">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#VFRReportTable').DataTable({ "lengthMenu": [[ -1,10, 25, 50], ["All",10, 25, 50]]});
             calculateColumn(3);
        $('#VFRReportTable_filter input[type=search]').keyup(function () {
            calculateColumn(3);
        });
        });
