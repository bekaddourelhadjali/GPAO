...
@section('content')
    <div class="container-fluid">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-VFRReport" role="tabpanel"
                 aria-labelledby="nav-VFRReport-tab">

                <section>
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">

                            <a class="nav-item nav-link active " id="nav-VFRReport-tab" data-toggle="tab"
                               href="#nav-VFRReport" role="tab" aria-controls="nav-VFRReport"
                            ...
                            <a class="nav-item nav-link  " href="{{route('VFRRepAdv.index')}}"><b>Filtres Avancés</b></a>
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-container" id="VFRReportTableContainer">
                                <table class="table table-bordered table-striped" id="VFRReportTable"
                                       cellspacing="0">
                                ...
                                </table> @if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->role == "Chef Controle")
...
@section('script')
    ...
    <script>
        ...
        var table = $('#VFRReportTable').DataTable({
            "bDestroy": true,
            "bRetrieve": true
        });
        ...
        $(document).ready(function () {
            ...
            $('.reportEdit').click(function () {
                ...
                var win = window.open("{{url('/VFRefuses/')}}/" + id, '_blank');
                if (win) {
        ...
        function addActions() {
            ...
            $("#Reports TR, #ArretReports TR").each(function () {
                ...
                $(this).mouseenter(function () {
                    ...
                    var height = ((($(this).height()) - $('#tr-actions').height()) / 2) + $('#VFRReportTable_wrapper .row').height() + 5;
                    var width = (($('#VFRReportTableContainer').width() - $('#tr-actions').width()) / 2);
                ...
                success: function (result) {
                    ...
                    if (result.reports.length > 0) {
                        result.reports.forEach(function (item) {
                            ...
                            $('#VFRReportTable tbody tr:last-child')
