                    ...
                    <form method="post" action="{{route('rapports_M3.store')}}">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group  row">
                                <label class="col-4" for="Pid ">Projet</label>
                                <select class="form-control col-4" id="Pid " name="Pid">
                                    @if(isset($projets))
                                        @foreach($projets as $projet)
                                            <option value="{{$projet->Pid}}">{{$projet->Nom}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
