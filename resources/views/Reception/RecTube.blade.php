...
@section('style')
    <title>Rapport De Réception Des Tubes</title>
     <style>
    ...
    <div class="container-fluid">
        ...
        <section>
            <div class="row" id="bottom-actions">
                ...
                <div class="  col-lg-3 col-md-3 col-sm-6">
                    <form method="post" action="{{route('rapports_Reception.destroy',["id"=>$rapport->Numero])}}">
                        @csrf
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.rapportState.Etat === 'C') {
                            ...
                            window.location.href = '{{route("rapports_Reception.index")}}';
