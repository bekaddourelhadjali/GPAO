        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('settings') }}" aria-label="{{ __('Settings') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="daten" type="date" class="form-control{{ $errors->has('daten') ? ' is-invalid' : '' }}" name="daten" value="{{Auth::user()->daten}}" required autofocus>
