        ...
        <div class="row">
            <div class="body-content col-xl-6 col-lg-6 col-md-8 offset-xl-0 offset-lg-0 offset-md-2 col-sm-12 " >
                <section class="col-12">
                    <form method="post" action="{{route('rapports_M25.store')}}">
                        @csrf
                        <fieldset>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#reprendreButton').click(function(e){
                ...
                $.ajax({
                    url:  "{{url('/rapports_M25/')}}/" + tube + '/edit',
                    method: 'get',
                    ...
                    error: function(result){
                        ...
                        if(result!==undefined )
                            if(result.responseJSON.message.includes('Undefined offset: 0')){
                                alert("Tube n°= "+tube+" n'existe pas dans les rapports chanfreinage-M25");
                            }else{
                                alert("Tube n°= "+tube+" n'existe pas dans les rapports chanfreinage-M25");
                            }
                    }
            ...
            function AddListeners(){
                ...
                $('.NotClot').each(function(){
                    $(this).dblclick(function(){
                        id=$(this).attr('id').replace(/[^0-9]/g,'');
                        window.location.href='{{url("/M25/")}}/'+id;
                    });
                });
            }
