...
@section('content')
    <div class="container">
        ...
        <section>
            <div class="tab-pane fade show active" id="bobPrep" role="tabpanel" aria-labelledby="bobPrep-tab">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="rapport-tab" href="{{route('arret_machine.show', ['id'=>$rapport->Numero])}}"
                           aria-selected="false">Arrets Machine</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active  text-dark " id="bobPrep-tab" data-toggle="tab" href="#bobPrep"
                           role="tab"
                           aria-controls="bobPrep" aria-selected="true">Préparation des Bobines</a>
                    </li>
            ...
            <div class="table-container">
                <table id="MsTable" class="table table-striped table-hover table-bordered Mss " style="max-width:120%">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="width:120px !important;"></th>
                    </tr>
                    <tr>
                        <th>Deb</th>
                        <th>Fin</th>
