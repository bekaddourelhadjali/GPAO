        ...
        <div class="row">
            <div class="body-content col-xl-6 col-lg-6 col-md-8 offset-xl-0 offset-lg-0 offset-md-2 col-sm-12 " >
                <section class="col-12">
                    <form method="post" action="{{route('rapports_FoncRevInt.store')}}">
                        @csrf
                        <fieldset>
...
@section('script')
        ...
        $(document).ready(function(){
            ...
            function AddListeners(){
                ...
                $('.NotClot').each(function(){
                    ...
                    $(this).dblclick(function(){
                        id=$(this).attr('id').replace(/[^0-9]/g,'');
                        window.location.href='{{url("/FoncRevInt/")}}/'+id;
                    });
                });
            }
    ...
    @include('layouts.ReprendreRapScript',['rapport'=>'rapports_FoncRevInt','next'=>'FoncRevInt'])
@endsection
