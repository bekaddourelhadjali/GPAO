...
@section('style')
    <title>Rapport De Revêtement Intérieur</title>
      <style>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.rapportState.Etat === 'C') {
                            ...
                            window.location.href = '{{route("rapports_RevInt.index")}}';
