...
class CreateM3ReportView extends Migration
{
    ...
    public function up()
    {
        \Illuminate\Support\Facades\DB::statement('create view M3Report as( select m."Id", b."Etat",d."Diametre",b."Arrivage",b."Epaisseur",b."Coulee",b."Bobine",b."Poids",b."LargeurBande",m."DateSaisie"
