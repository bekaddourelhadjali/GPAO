...
class RX2ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Reports.RX2.RX2Report', [
                'reports' => $RX2Report,
                'MonthNBT' => $MonthNBT,
                'YearNBT' => $YearNBT, 
                'details' => $details,
    ...
    public function show(Request $request,$id)
    {
        $months = array(
            ...
            8 => 'Août', 9 => 'Septembre', 10 => 'Octobre',
            11 => 'Novembre', 12 => 'Décembre');
        $RX2Report = DB::select('select "DateSaisie"::date,"Poste","Machine","CodeSoude",count(*) "NBT"  from "rx2report" where "Did"=? group by "DateSaisie"::date,"Poste","Machine" ,"CodeSoude" ', [$id]);
